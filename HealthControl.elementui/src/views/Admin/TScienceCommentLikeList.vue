        ...
        <el-card class="box-card">
            ...
            <div class="margin-top-sm">
                <el-form :inline="true" :model="searchForm" size="default">
                    ...
                    <el-form-item label="关联评论表主键">
                        <SigleSelect url="/TScienceComment/List" class="search-input" columnName="CommentContent" :clearable="true" columnValue="Id"
                            v-model="searchForm.CommentId">
                        </SigleSelect>
                    </el-form-item>                
                    <el-form-item label="取消点赞时间" class="search-input">
                        <el-date-picker v-model="searchForm.UpdateTimeRange" type="datetimerange" start-placeholder="开始取消点赞时间"
                            end-placeholder="结束取消点赞时间" value-format="YYYY-MM-DD HH:mm:ss" >
                        </el-date-picker>                                       
                    </el-form-item>                
                    <el-form-item label="点赞操作时间" class="search-input">
                        <el-date-picker v-model="searchForm.LikeTimeRange" type="datetimerange" start-placeholder="开始点赞操作时间"
                            end-placeholder="结束点赞操作时间" value-format="YYYY-MM-DD HH:mm:ss" >
                        </el-date-picker>                                       
                    </el-form-item>                
                    <el-form-item label="取消点赞操作时间" class="search-input">
                        <el-date-picker v-model="searchForm.CancelLikeTimeRange" type="datetimerange" start-placeholder="开始取消点赞操作时间"
                            end-placeholder="结束取消点赞操作时间" value-format="YYYY-MM-DD HH:mm:ss" >
                        </el-date-picker>                                       
                    </el-form-item>                
...
<!-- 编辑对话框 -->
        <el-dialog :title="formData.Id ? '修改科普评论点赞' : '添加科普评论点赞'" v-model="editorShow" width="50%" :lock-scroll="true"
            min-height="500px">
            <el-form v-if="editorShow" ref="editModalForm" :rules="editModalFormRules" :model="formData" label-width="140px"
              ...
              <el-row :gutter="10" class="edit-from-body">
                    ...
                    <el-col :span="24">
                        <el-form-item label="取消点赞时间" prop="UpdateTime">
                    ...
                    <el-col :span="24">
                        <el-form-item label="关联评论表主键" prop="CommentId">
                          <SigleSelect url="/TScienceComment/List" columnName="CommentContent" columnValue="Id"  v-model="formData.CommentId" >
                          </SigleSelect>
                        </el-form-item>
                    </el-col>

                    <el-col :span="24">
                        <el-form-item label="点赞操作时间" prop="LikeTime">
                            <el-date-picker v-model="formData.LikeTime" align="right" type="datetime" placeholder="选择时间" value-format="YYYY-MM-DD HH:mm:ss">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>

                    <el-col :span="24">
                        <el-form-item label="取消点赞操作时间" prop="CancelLikeTime">
                            <el-date-picker v-model="formData.CancelLikeTime" align="right" type="datetime" placeholder="选择时间" value-format="YYYY-MM-DD HH:mm:ss">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
        ...
        <!-- 数据表格 -->
        <PaginationTable ref="PaginationTableId" url="/TScienceCommentLike/List" :column="columnList" :where="where">
            <template v-slot:header>
                ...
                <ExportButton exportUrl="/TScienceCommentLike/Export" :where="searchForm"></ExportButton>        
            </template>
...
const ShowEditModal = async (Id) => {
    ...
    const { Data } = await Post(`/TScienceCommentLike/Get`, { Id: Id });
...
const CreateOrEditForm = async () => {
    ...
    await editModalForm.value.validate(async valid => {
        if (valid) {
            const { Success } = await Post(`/TScienceCommentLike/CreateOrEdit`, formData);
...
const BatchDelete = async () => {
    ...
    if (ids.length > 0) {
        try {
            ...
            const { Success } = await Post(`/TScienceCommentLike/BatchDelete`, { Ids: ids });
            if (Success) {
                PaginationTableId.value.Reload(searchForm);
                ElMessage.success('删除成功');
            }
