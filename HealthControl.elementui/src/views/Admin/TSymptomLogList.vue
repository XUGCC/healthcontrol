        ...
        <el-card class="box-card">
            ...
            <div class="margin-top-sm">
                <el-form :inline="true" :model="searchForm" size="default">
                    <el-form-item label="症状持续时长" prop="SymptomDuration">
                        <el-input v-model.trim="searchForm.SymptomDuration"  placeholder="请输入症状持续时长"  :clearable="true" ></el-input>
                    </el-form-item>
                    <el-form-item label="症状备注" prop="Remark">
                        <el-input v-model.trim="searchForm.Remark"  placeholder="请输入症状备注"  :clearable="true" ></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="症状首次出现时间" class="search-input">
                        <el-date-picker v-model="searchForm.SymptomOccurTimeRange" type="datetimerange" start-placeholder="开始症状首次出现时间"
                            end-placeholder="结束症状首次出现时间" value-format="YYYY-MM-DD HH:mm:ss" >
                        </el-date-picker>                                       
                    </el-form-item>                
 							 <el-form-item label="症状类型" class="search-input">
                 		 <el-select v-model="searchForm.SymptomType" class="search-input" :clearable="true" placeholder="请选择症状类型" >
                          <el-option  key="true"  label="是"  value="true">
                           ...
                           <el-option  key="false"  label="否"  value="false">
 							 ...
 							 <el-form-item label="症状轻重" class="search-input">
                 		 <el-select v-model="searchForm.SymptomLevel" class="search-input" :clearable="true" placeholder="请选择症状轻重" >
                          <el-option  key="true"  label="是"  value="true">
                          </el-option>
                           <el-option  key="false"  label="否"  value="false">
                          </el-option>
...
<!-- 编辑对话框 -->
        <el-dialog :title="formData.Id ? '修改症状日志' : '添加症状日志'" v-model="editorShow" width="50%" :lock-scroll="true"
            min-height="500px">
              ...
              <el-row :gutter="10" class="edit-from-body">
                    ...
                    <el-col :span="24">
                        <el-form-item label="症状类型" prop="SymptomType">
                       		  <el-switch v-model="formData.SymptomType"  :active-value="true" :inactive-value="false">
                            </el-switch>                          
                        </el-form-item>
                    </el-col>

                    <el-col :span="24">
                        <el-form-item label="症状轻重" prop="SymptomLevel">
                       		  <el-switch v-model="formData.SymptomLevel"  :active-value="true" :inactive-value="false">
                            </el-switch>                          
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="24">
                        <el-form-item label="症状持续时长" prop="SymptomDuration">
                            <el-input type="text" v-model="formData.SymptomDuration"  placeholder="请输入症状持续时长"     :clearable="true"></el-input>
                        </el-form-item>
                    </el-col>


                    <el-col :span="24">
                        <el-form-item label="症状首次出现时间" prop="SymptomOccurTime">
                            <el-date-picker v-model="formData.SymptomOccurTime" align="right" type="datetime" placeholder="选择时间" value-format="YYYY-MM-DD HH:mm:ss">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="24">
                        <el-form-item label="症状备注" prop="Remark">
                            <el-input type="text" v-model="formData.Remark"  placeholder="请输入症状备注"     :clearable="true"></el-input>
                        </el-form-item>
                    </el-col>
        ...
        <!-- 数据表格 -->
        <PaginationTable ref="PaginationTableId" url="/TSymptomLog/List" :column="columnList" :where="where">
            <template v-slot:header>
                ...
                <ExportButton exportUrl="/TSymptomLog/Export" :where="searchForm"></ExportButton>        
            </template>
...
const CreateOrEditForm = async () => {
    ...
    await editModalForm.value.validate(async valid => {
        if (valid) {
            const { Success } = await Post(`/TSymptomLog/CreateOrEdit`, formData);
...
const ShowDeleteModal = async (Id) => {
    ...
    try {
        ...
        const { Success } = await Post(`/TSymptomLog/Delete`, { Id: Id });
        if (Success) {
            PaginationTableId.value.Reload(searchForm);
...
const BatchDelete = async () => {
    ...
    if (ids.length > 0) {
        try {
            ...
            const { Success } = await Post(`/TSymptomLog/BatchDelete`, { Ids: ids });
            if (Success) {
                PaginationTableId.value.Reload(searchForm);
                ElMessage.success('删除成功');
            }
